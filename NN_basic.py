...
nn = NeuralNetwork(n_output = 10, n_features = train_images.shape[1], n_hidden=50, l1=0.1, l2=0.0, epochs=1000, eta=0.001, alpha=0.001, decrease_const=0.00001, shuffle=True, minibatches=50, random_state=1)

nn.fit(train_images, train_labels, print_progress=True)

plt.plt(range(len(nn.cost_)), nn.cost_)
plt.ylim([0, 2000])
plt.ylabel('Cost')
